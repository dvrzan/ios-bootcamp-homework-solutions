...
extension Task {
    static let example = [
        Task(title: "Brush up on a foreign language", category: .personal, isCompleted: true),
        Task(title: "Edit the vacation photos", category: .personal),
        Task(title: "Finish knitting the scarf", category: .home)
    ]
}
